...
about:
    path:
        en: /about
        es: /acerca-de
    component: pages/About`}),e.jsx(x,{icon:"🔒",title:"Type Safety",description:"Generated TypeScript types catch errors before they reach production. Full autocomplete and IntelliSense support.",codeExample:`import { routeTo } from "./routes.gen";
...
🎉 Route generation completed!`}),e.jsx(m,{language:"typescript",title:"App.tsx",children:`import { routeTo } from "./routes.gen";
